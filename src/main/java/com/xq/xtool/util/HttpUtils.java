...
public class HttpUtils {
     ...
     * @return url响应实体
     */
    public static String postRequest(String url) throws UnsupportedEncodingException {
     ...
     * @return
     */
    public static String postRequestFormat(String url, Map<String, Object> params) {
        return postRequestFormat(url, null, params);
    }

    /**
     * 发送http post的表单请求，并返回响应实体
     *
     * @param url     访问的url
    ...
    public static String postRequest(String url, Map<String, String> headers,
                                     Object date) throws UnsupportedEncodingException {
        String result = null;
        ...
        httpPost.setEntity(new StringEntity(JSONObject.toJSONString(date)));
     ...
     * @return
     */
    public static String postRequestFormat(String url, Map<String, String> headers,
    ...
    public static void main(String[] args) {
        ...
        String result = HttpUtils.postRequestFormat(url, params);
